...
public class GradeSubmissionApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		} // these students are added to the repository right after the application goes running, this is intended only for developing purposes; this bunch of code can be deleted in the final version of the application
		...
		} // these courses are added to the repository right after the application goes running, this is intended only for developing purposes; this bunch of code can be deleted in the final version of the application
